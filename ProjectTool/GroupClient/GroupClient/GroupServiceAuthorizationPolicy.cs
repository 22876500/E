...
{
    public class GroupServiceAuthorizationPolicy : System.IdentityModel.Policy.IAuthorizationPolicy
    {
    ...
    public class GroupServiceAuthorizationManager : ServiceAuthorizationManager
    {
