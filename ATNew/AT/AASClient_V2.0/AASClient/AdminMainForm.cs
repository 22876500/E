...
namespace AASClient
{
    public partial class AdminMainForm : Form
    {
        ...
        private void AdminMainForm_Load(object sender, EventArgs e)
        {
            ...
            Thread autoLoginThread = new Thread(new ThreadStart(NeedAutoRegloginTest)) { IsBackground = true };
        ...
        private void 删除交易额度ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                var trader = DataGridViewRow1.Cells["Column13"].Value as string;
                var stockCode = DataGridViewRow1.Cells["Column14"].Value as string;
                var groupAccount = DataGridViewRow1.Cells["Column15"].Value as string;
                Program.AASServiceClient.DeleteTradeLimit(trader, stockCode, groupAccount);//交易员 列 证券代码列
            }
        ...
        DateTime ErrorTime;
        private void NeedAutoRegloginTest()
        {
            while (true)
            {
                try
