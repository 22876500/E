...
namespace AASClient
{
    public partial class ClosedTradeForm : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        private void ClosedTradeForm_Load(object sender, EventArgs e)
        {
            ...
            this.dataGridView已平仓订单.Columns["已开数量"].DefaultCellStyle.Format = "f0";
            this.dataGridView已平仓订单.Columns["已平数量"].DefaultCellStyle.Format = "f0";

            this.dataGridView已平仓订单.Columns["毛利"].DefaultCellStyle.Format = "f2";
            this.dataGridView已平仓订单.Columns["已开金额"].DefaultCellStyle.Format = "f2";
            this.dataGridView已平仓订单.Columns["已平金额"].DefaultCellStyle.Format = "f2";
        }
