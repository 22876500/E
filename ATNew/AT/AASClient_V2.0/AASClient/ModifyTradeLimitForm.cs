...
namespace AASClient
{
    public partial class ModifyTradeLimitForm : Form
    {
        ...
        private void ModifyTradeLimitForm_Load(object sender, EventArgs e)
        {
            ...
            this.comboBox交易员.Items.Add(额度分配.交易员);
            ...
            //}
            this.comboBox组合号.Items.Add(额度分配.组合号);
        ...
        {
            Program.AASServiceClient.UpdateTradeLimit(this.额度分配.交易员, this.额度分配.证券代码, this.额度分配.组合号, (byte)this.comboBox市场.SelectedIndex, this.textBox证券名称.Text, this.textBox拼音缩写.Text, (买模式)this.comboBox买模式.SelectedIndex, (卖模式)this.comboBox卖模式.SelectedIndex, this.numericUpDown交易额度.Value, this.numericUpDown手续费率.Value);
