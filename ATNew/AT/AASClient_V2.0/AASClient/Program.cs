...
namespace AASClient
{
    static class Program
    {
        ...
        public static string Port = "808";//普通用40808,测试用808
        ...
        public static ConcurrentQueue<可用仓位DataTableChange> 可用仓位表通知 = new ConcurrentQueue<可用仓位DataTableChange>();
        ...
        static void Main()
        {
            ...
            //NetTcpBinding.ReliableSession.InactivityTimeout = TimeSpan.FromHours(4);
            ...
            //WSDualHttpBinding.MaxBufferPoolSize = 2147483647;
            //WSDualHttpBinding.MaxReceivedMessageSize = 2147483647;
            //WSDualHttpBinding.OpenTimeout = new TimeSpan(0, 0, 30);
            //WSDualHttpBinding.SendTimeout = new TimeSpan(0, 0, 30);
            //WSDualHttpBinding.ReceiveTimeout = new TimeSpan(4, 0, 0);
            ////WSDualHttpBinding1.ReliableSession.Enabled = true;
            //WSDualHttpBinding.ReliableSession.InactivityTimeout = TimeSpan.FromHours(4);

            //WSDualHttpBinding.ReaderQuotas.MaxStringContentLength = 0xfffffff;
            //WSDualHttpBinding.ReaderQuotas.MaxArrayLength = 0xfffffff;
            //WSDualHttpBinding.ReaderQuotas.MaxBytesPerRead = 0xfffffff;
            //WSDualHttpBinding.ReaderQuotas.MaxDepth = 0xfffffff;
            ...
            if (L2MultiApi.IsOpened)
            {
                L2MultiApi.Instance.Close();
            }
        }
        ...
        static bool isConnectting = false;
