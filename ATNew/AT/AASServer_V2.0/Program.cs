...
namespace AASServer
{
    ...
    static class Program
    {
        ...
        public static ConcurrentDictionary<string, object> SendOrderObjDict = new ConcurrentDictionary<string, object>();
        ...
        public static YJServiceReference.DataServiceClient DataServiceClient;
        /// <summary>
        /// 应用程序的主入口点。
        /// </summary>
        [STAThread]
