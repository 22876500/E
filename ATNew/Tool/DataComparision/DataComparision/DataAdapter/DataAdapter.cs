...
namespace DataComparision.DataAdapter
{
    public class DataHelper
    {
        ...
        /// <param name="historyDataType">表示查询信息的种类，0历史委托  1历史成交 2可用资金  3交割单</param>
        /// <returns></returns>
        public static DataTable QueryHisData(DateTime st, DateTime et, 券商 o, int historyDataType = 3, bool originalData = false)
        {
            DataTable dt = null;
            ...
            else
            {
                ...
                if (ErrInfo.Length == 0)
                {
                    ...
                    if (!originalData && (historyDataType == 3 || (historyDataType==2 && o.名称 == "F17")) )
                    {
