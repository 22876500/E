...
namespace Binance.API.Csharp.Client.Domain.Abstract
{
    public abstract class ApiClientAbstract
    {
        ...
        public ApiClientAbstract(string apiKey, string apiSecret, string apiUrl = @"https://www.binance.com", string webSocketEndpoint = @"wss://stream.binance.com:9443/", bool addDefaultHeaders = true)
        {
            _apiUrl = apiUrl;
            _apiKey = apiKey;
