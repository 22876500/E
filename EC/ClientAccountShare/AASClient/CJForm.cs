...
namespace AASClient
{
    public partial class CJForm : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        private void CJForm_Load(object sender, EventArgs e)
        {
            ...
            this.dataGridView成交.Columns["成交数量"].DefaultCellStyle.Format = "f4";
        }
        ...
        private void dataGridView成交_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
            Program.logger.LogInfo(string.Format("CJForm DataError {0}", (e.Exception.InnerException ?? e.Exception).Message));
        }
    }
}
