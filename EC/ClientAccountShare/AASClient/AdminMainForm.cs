...
namespace AASClient
{
    public partial class AdminMainForm : Form
    {
        ...
        #region Top Menu Click

        private void 电子币帐户编辑ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var win = new ECoinAccount.formECoinAccountList();
            win.ShowDialog();
        }

        private void 交易员关联帐户编辑ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            
        }

        private void 可用资金编辑ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void 电子币帐户ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var win = new ECoinAccount.formECoinAccountList();
            win.ShowDialog();
        }

        private void 交易员关联帐户ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var win = new ECoinAccountRelation.TraderRelationAccountList();
            win.ShowDialog();
        }

        private void 账户资金ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var win = new UserCoins.UserCoinsList();
            win.ShowDialog();
        }
    }
}
