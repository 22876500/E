    ...
    public partial class HqForm : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //}
                    //else if (!string.IsNullOrWhiteSpace(label跌停价.Text) && numericUpDown价格.Value <3. decimal.Parse(label跌停价.Text))
                    //{
        ...
        private void comboBox代码_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (Regex1.IsMatch(this.comboBox代码.Text) || this.comboBox代码.Text == "TF1803")
                {
                    string Zqdm = this.comboBox代码.Text; //Regex1.Match(this.comboBox代码.Text).Value;
        ...
        private void comboBox代码_TextChanged(object sender, EventArgs e)
        {
            ...
            if ((this.comboBox代码.Text.Length == 5 || this.comboBox代码.Text.Length == 6))
            {
